...
- **2022** : 1 696 étudiants
- **2023** : 1 150 étudiants (-32%)
- **2024** : 850 étudiants (-26%)
- **2025** : 951 étudiants (+12%)

### Répartition par genre (2025)
- **Hommes** : 62.67%
- **Femmes** : 30.6%
- **Non renseigné** : 6.73%

### Tendance positive
- Part des femmes : +72% entre 2022 et 2025 (de 17.81% à 30.6%)
- Qualité des données : Données non renseignées divisées par 6 (de 41.63% à 6.73%)

### Répartition géographique
- **Île-de-France** : 31% des étudiants
- **Top 5 régions** : 64% des étudiants

### Profil d'âge
- **25-34 ans** : 56% des étudiants (cible principale)
...
2. **Fichier CSV** consolidé (`demo_par_annee.csv`)
